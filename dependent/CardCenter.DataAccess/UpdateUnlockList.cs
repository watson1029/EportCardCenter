...
{
	/// <summary>
	/// 数据访问类:UpdateUnlockList
	/// </summary>
    public partial class UpdateUnlockList : BaseDA
	{
		...
		public bool Exists(string ListID)
		{
			...
			strSql.Append("select count(1) from UpdateUnlockList");
		...
		/// 增加一条数据
		/// </summary>
		public void Add(CardCenter.Entity.UpdateUnlockList model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into UpdateUnlockList(");
            strSql.Append("ListID,JobID,JobType,CardType,CardNum,CardholderName,CardholderIdentificationType,CardholderIdentificationNum,IsDelete,Remark)");
		...
		public void Delete(string ListID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from UpdateUnlockList ");
			strSql.Append(" where ListID=@ListID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ListID", SqlDbType.NVarChar,64)			};
			parameters[0].Value = ListID;
		...
		/// 得到一个对象实体
		/// </summary>
		public CardCenter.Entity.UpdateUnlockList GetModel(string ListID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ListID,JobID,JobType,CardType,CardNum,CardholderName,CardholderIdentificationType,CardholderIdentificationNum,IsDelete,Remark from UpdateUnlockList ");
			strSql.Append(" where ListID=@ListID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ListID", SqlDbType.NVarChar,64)			};
			parameters[0].Value = ListID;

			CardCenter.Entity.UpdateUnlockList model=new CardCenter.Entity.UpdateUnlockList();
		...
		/// 得到一个对象实体
		/// </summary>
		public CardCenter.Entity.UpdateUnlockList DataRowToModel(DataRow row)
		{
			CardCenter.Entity.UpdateUnlockList model=new CardCenter.Entity.UpdateUnlockList();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ListID,JobID,JobType,CardType,CardNum,CardholderName,CardholderIdentificationType,CardholderIdentificationNum,IsDelete,Remark ");
			strSql.Append(" FROM UpdateUnlockList ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from UpdateUnlockList T ");
        ...
        //public string GetInsertSql(CardCenter.Entity.UpdateUnlockList model)
        //{
        //    StringBuilder strSql = new StringBuilder();
        //    strSql.Append("insert into UpdateUnlockList(");
        //    strSql.Append("ListID,JobID,JobType,CardType,CardNum,CardholderName,CardholderIdentificationType,CardholderIdentificationNum,IsDelete,Remark)");
        ...
        //public string GetUpdateSql(CardCenter.Entity.UpdateUnlockList model)
        //{
        //    StringBuilder strSql = new StringBuilder();
        //    strSql.Append("update UpdateUnlockList set ");
        //    strSql.AppendFormat("JobID='{0}',JobType='{1}',CardType='{2}',CardNum='{3}',CardholderName='{4}',CardholderIdentificationType={5},CardholderIdentificationNum={6},IsDelete={7},Remark='{8}' where ListID='{9}' "
        //        , model.JobID
        //        , model.JobType
        //        , model.CardType
        //        , model.CardNum
