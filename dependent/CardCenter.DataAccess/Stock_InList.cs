...
namespace CardCenter.DataAccess
{
	...
	/// 数据访问类:Stock_InList
	/// </summary>
	public partial class Stock_InList : BaseDA
	{
		public Stock_InList()
		{}
		#region  BasicMethod
		...
		public bool Exists(string Guid)
		{
			...
			strSql.Append("select count(1) from Stock_InList");
		...
		/// 增加一条数据
		/// </summary>
		public void Add(CardCenter.Entity.Stock_InList model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Stock_InList(");
			strSql.Append("Guid,CommodityGuid,Before,After,Num,SubmitUser,SubmitTime,Remark)");
		...
		public void Delete(string Guid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Stock_InList ");
			strSql.Append(" where Guid=@Guid ");
			SqlParameter[] parameters = {
					new SqlParameter("@Guid", SqlDbType.NVarChar,64)			};
			parameters[0].Value = Guid;
		...
		/// 得到一个对象实体
		/// </summary>
		public CardCenter.Entity.Stock_InList GetEntity(string Guid)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Guid,CommodityGuid,Before,After,Num,SubmitUser,SubmitTime,Remark from Stock_InList ");
			strSql.Append(" where Guid=@Guid ");
			SqlParameter[] parameters = {
					new SqlParameter("@Guid", SqlDbType.NVarChar,64)			};
			parameters[0].Value = Guid;

			CardCenter.Entity.Stock_InList model=new CardCenter.Entity.Stock_InList();
		...
		/// 得到一个对象实体
		/// </summary>
		public CardCenter.Entity.Stock_InList DataRowToEntity(DataRow row)
		{
			CardCenter.Entity.Stock_InList model=new CardCenter.Entity.Stock_InList();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Guid,CommodityGuid,Before,After,Num,SubmitUser,SubmitTime,Remark ");
			strSql.Append(" FROM Stock_InList ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Stock_InList T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Stock_InList";
