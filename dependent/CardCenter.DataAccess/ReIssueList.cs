...
namespace CardCenter.DataAccess
{
	...
	/// 数据访问类:ReIssueList
	/// </summary>
    public partial class ReIssueList : BaseDA
	{
		public ReIssueList()
		{}
		#region  BasicMethod
		...
		public bool Exists(string ListID)
		{
			...
			strSql.Append("select count(1) from ReIssueList");
		...
		/// 增加一条数据
		/// </summary>
		public void Add(CardCenter.Entity.ReIssueList model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ReIssueList(");
			strSql.Append("ListID,JobID,JobType,CardType,CardholderName,CardholderIdentificationType,CardholderIdentificationNum,IsDelete,Remark)");
		...
		/// 更新一条数据
		/// </summary>
		public void Update(CardCenter.Entity.ReIssueList model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ReIssueList set ");
			...
			parameters[4].Value = model.CardholderIdentificationType;
			parameters[5].Value = model.CardholderIdentificationNum;
			parameters[6].Value = model.IsDelete;
			parameters[7].Value = model.Remark;
			parameters[8].Value = model.ListID;
		...
		public void Delete(string ListID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ReIssueList ");
			strSql.Append(" where ListID=@ListID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ListID", SqlDbType.NVarChar,64)			};
			parameters[0].Value = ListID;
		...
		/// 得到一个对象实体
		/// </summary>
		public CardCenter.Entity.ReIssueList GetModel(string ListID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ListID,JobID,JobType,CardType,CardholderName,CardholderIdentificationType,CardholderIdentificationNum,IsDelete,Remark from ReIssueList ");
			strSql.Append(" where ListID=@ListID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ListID", SqlDbType.NVarChar,64)			};
			parameters[0].Value = ListID;

			CardCenter.Entity.ReIssueList model=new CardCenter.Entity.ReIssueList();
		...
		/// 得到一个对象实体
		/// </summary>
		public CardCenter.Entity.ReIssueList DataRowToModel(DataRow row)
		{
			CardCenter.Entity.ReIssueList model=new CardCenter.Entity.ReIssueList();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ListID,JobID,JobType,CardType,CardholderName,CardholderIdentificationType,CardholderIdentificationNum,IsDelete,Remark ");
			strSql.Append(" FROM ReIssueList ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ReIssueList T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ReIssueList";
        ...
        //public string GetInsertSql(CardCenter.Entity.ReIssueList model)
        //{
        //    StringBuilder strSql = new StringBuilder();
        //    strSql.Append("insert into ReIssueList(");
        //    strSql.Append("ListID,JobID,JobType,CardType,CardholderName,CardholderIdentificationType,CardholderIdentificationNum,IsDelete,Remark)");
        ...
        //public string GetUpdateSql(CardCenter.Entity.ReIssueList model)
        //{
        //    StringBuilder strSql = new StringBuilder();
        //    strSql.Append("update ReIssueList set ");
        //    strSql.AppendFormat("JobID='{0}',JobType='{1}',CardType='{2}',CardholderName='{3}',CardholderIdentificationType={4},CardholderIdentificationNum={5},IsDelete={6},Remark='{7}' where ListID='{8}' "
        //        , model.JobID
        //        , model.JobType
        //        , model.CardType
        //        , model.CardholderName
