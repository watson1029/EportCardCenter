...
namespace CardCenter.Entity
{
    ...
    /// </summary>
    [Serializable]
    [DBEntityProperty(TableName = "NewlyAddedList")]
    public partial class NewlyAddedList
    {
        ...
        /// 持卡人手机号
        /// </summary>
        [DBRowEntityProperty(ColunmName = "CardholderPhone", ColunmType = "string", CanEmpty = true, Length = 32, IsDataTableRow = true, IsPrimarykey = false, IsIncrement = false, HaveDefaultValue = false)]
        public string CardholderPhone
        {
            set { _cardholderphone = value; }
