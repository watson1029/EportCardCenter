...
namespace CardCenter.Ajax
{
    ...
    /// NAListDelete 的摘要说明
    /// </summary>
    public class NAListDelete : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            DataSet view = new DataAccess.RunProcedure().JobView(jobID, "NewlyAddedList");
            if (view.Tables[3].Rows[0]["StatusName"].Equals("未提交."))
            {
                if (new DataAccess.RunProcedure().NAListDelete(listID))
