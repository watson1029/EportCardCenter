...
namespace CardCenter.Ajax
{
    ...
    /// UUListDelete 的摘要说明
    /// </summary>
    public class UUListDelete : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            DataSet view = new DataAccess.RunProcedure().JobView(jobID, "UpdateUnlockList");
            if (view.Tables[3].Rows[0]["StatusName"].Equals("未提交."))
            {
                if (new DataAccess.RunProcedure().UUListDelete(listID))
