<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReMake.aspx.cs" Inherits="CardCenter.ApplyForm.ReMake" %>
                ...
                success: function (data) {
                    if (data.error == "") {
                        if (type == "complete") {
                            ...
                            location.href = "ReMakeList.aspx?jobID=" + data.msg;
                        }
                    }
                    else {
                        if (type == "complete") {
    ...
    联系咨询电话：020-83939000。
                    ...
                    <div id="wiz1step2_4">
                        ...
                        <p class="stdformbutton">
                        	<button id="btnAddList" class="submit radius2" runat="server" onclick="onSave('add');return false;">重制卡信息</button>
                        </p>
                                ...
                                <asp:Repeater ID="repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr id="<%# Eval("ListID") %>">
                                            ...
                                            <td class="con0"><a href="ReMakeList.aspx?jobID=<%=jobID %>&listID=<%# Eval("ListID") %>">修改</a>&nbsp;&nbsp;<a href="#" onclick="deleteRMList(this)">删除</a></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </tbody>
