<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReMakeList.aspx.cs" Inherits="CardCenter.ApplyForm.ReMakeList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function Submit() {
            if (RMJobListSaveVerifi()) {
                jQuery.ajax({
                    type: "POST",
                    dataType: "text",
                    url: "../Ajax/RMListSave.ashx",
                    data: $('#form1').serialize(),
                    success: function (msg) {
                        if (msg == "") {
                            jAlert("保存成功", "提示", function () {
                                location.href = "ReMake.aspx?jobID=" + jQuery("#hJobID").val() + "&type=callback";
                            });
                        }
                        else
    ...
    <div class="centercontent">
        <div id="contentwrapper" class="contentwrapper">
            <ul class="breadcrumbs">
                ...
                <li><a href="ReMake.aspx?jobID=<%= jobID %>&type=callback">重制业务-工单</a></li>
                <li>重制业务-工单项</li>
            </ul>
            <div id="tabbed" class="subcontent">
                <form id="form1" class="stdform" method="post" action="" runat="server">
                    ...
                    <div class="pageheader notab">
                        <h1 class="pagetitle">重制业务信息录入</h1>
                    </div>
                    <table class="table">
                        <tr>
                            <td class="title1">
