<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Statistics1.aspx.cs" Inherits="CardCenter.Management.Manager.Report.Statistics1" %>
...
<body>
    <div class="pageheader notab">
        <h1 class="pagetitle" style="margin: 0 20px 10px 20px;">常规业务统计</h1>
        <span class="pagedesc" style="margin: 0 20px;">统计各类型业务数量，制卡点工单处理数量.</span>
    </div>
