<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Statistics5.aspx.cs" Inherits="CardCenter.Management.Manager.Report.Statistics5" %>
...
<body>
    <div class="pageheader notab">
        <h1 class="pagetitle" style="margin: 0 20px 10px 20px;">工单详细信息（广州关区）</h1>
        <span class="pagedesc" style="margin: 0 20px;">统计业务工单详细信息，包含广州地区和其他关区.</span>
    </div>
