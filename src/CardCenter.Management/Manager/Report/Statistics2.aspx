<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Statistics2.aspx.cs" Inherits="CardCenter.Management.Manager.Report.Statistics2" %>
...
<body>
    <div class="pageheader notab">
        <h1 class="pagetitle" style="margin: 0 20px 10px 20px;">支付统计</h1>
        <span class="pagedesc" style="margin: 0 20px;">统计已支付工单总数、网上(微信)支付笔数、网上(微信)支付总金额、现场支付笔数、现场支付总金额、未开发票数及明细.</span>
    </div>
