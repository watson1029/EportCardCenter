<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Statistics6.aspx.cs" Inherits="CardCenter.Management.Manager.Report.Statistics6" %>
...
<body>
    <div class="pageheader notab">
        <h1 class="pagetitle" style="margin: 0 20px 10px 20px;">工单详细信息（其他关区）</h1>
        <span class="pagedesc" style="margin: 0 20px;">统计业务工单详细信息，包含除广州以外的其他关区.</span>
    </div>
