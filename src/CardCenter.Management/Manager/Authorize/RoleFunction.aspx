<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleFunction.aspx.cs" Inherits="CardCenter.Management.Manager.Authorize.RoleFunction" %>
        ...
        window.onload = function () {
            ...
            jQuery("input:checkbox").click(function () {
                ...
                jQuery.ajax({
                    type: "POST",
                    dataType: "text",
                    url: "../../Ajax/Authorize/RoleFunction.ashx",
...
<body>
    <div class="pageheader notab">
        <h1 class="pagetitle" style="margin: 0 20px 10px 20px;">授权角色-功能</h1>
        <span class="pagedesc" style="margin: 0 20px;">授权角色可以处理的制卡功能.</span>
    </div>
    <div id="contentwrapper" class="contentwrapper">
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
            ...
            <tbody>
                ...
                <% { %>
                    <tr id="<%= funcDt.Rows[i]["ID"] %>">
                        <td class='con0'><%= funcDt.Rows[i]["Name"].ToString() %></td>
                        ...
                        <% { %>
                            <%= j%2 == 0 ? string.Format("<td class='con1' name='{0}'>", roleDt.Rows[j]["ID"].ToString()) : string.Format("<td class='con0' name='{0}'>", roleDt.Rows[j]["ID"].ToString())  %>
                                <% if (roleDt.Rows[j]["FunctionAuthorize"].ToString().IndexOf(funcDt.Rows[i]["ID"].ToString()) >= 0) %>
                                <% { %>
